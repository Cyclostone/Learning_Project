...
import 'package:learning_platform_app/pages/pharynx_content/compartments.dart';
...
class TermPharynxPage extends StatelessWidget {
  // final Lesson lesson;
  ...
  Widget build(BuildContext context) {
    final topContentText = Column(
      ...
      children: <Widget>[
        ...
        Text(
          "Terminology, Location and Extent",
    ...
    final bottomContentText = Column(
      children: <Widget>[
        ...
        ListTile(
          title: new Text(
            "Tube or cavity, with its surrounding membrane and muscles, that connects the mouth and nasal passages with the esophagus",
          ),
        ),
        ListTile(
          title: new Text(
        ...
        ListTile(
          ...
          title: new Text(
            "Situated behind nose, behind mouth and behind larynx",
          ),
        ),
        ListTile(
          leading: new MyBullet(),
        ...
        child: RaisedButton(
          onPressed: () => {
            Navigator.push(context,
                CupertinoPageRoute(builder: (context) => CompPharynxPage()))
          },
