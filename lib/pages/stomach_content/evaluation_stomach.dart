...
class EvalStoPage extends StatelessWidget {
  // final Lesson lesson;
  ...
  Widget build(BuildContext context) {
    ...
    final bottomContentText = Column(
      children: <Widget>[
        ListTile(
          ...
          title: new Text(
            "Upper GI endoscopy shows normal stomach",
        ...
        ListTile(
          leading: new MyBullet(),
          title: new Text("Barium meal"),
        ),
        ListTile(
          leading: new MyBullet(),
          title: new Text("Barium study of stomach and duodenum"),
        ),
        ListTile(
          leading: new MyBullet(),
          title: new Text(
            "Chest X-ray - fundic air shadow",
          ),
        ),
        ListTile(
          leading: new MyBullet(),
    ...
    final readButton = Container(
        ...
        child: RaisedButton(
          onPressed: () => {
            Navigator.push(
                context, CupertinoPageRoute(builder: (context) => AppAspPage()))
          },
